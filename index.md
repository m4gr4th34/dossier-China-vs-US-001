...
| Verification in progress | Live status: 194 ESTABLISHED, 76 OPEN-UNVERIFIED, 1 REPORTED. Batches 1–8 cover 1926–2003 at ~25 rows per batch; the rest (2003→, plus named early stragglers) are not yet promoted. | OPEN-UNVERIFIED | — | claim_ledger.csv, verification_log.md |
...
- [PASS] Census: 194 ESTABLISHED / 76 OPEN-UNVERIFIED / 1 REPORTED (live corpus counts)
...
The ledger itself — 271 rows, event-anchored, per-row-verified, 194 ESTABLISHED under the promotion standard — is the dossier's spine and its most finished part. It is asserted directly, because documented, dated, sourced achievements are bedrock, and timidity about them would be its own dishonesty.
...
> **OPEN-UNVERIFIED** — **Live status: 194 ESTABLISHED, 76 OPEN-UNVERIFIED, 1 REPORTED.** Verification runs in chronological batches of about twenty-five rows; batches one through eight cover 1926–2003. The rest are not yet promoted — including a few named early stragglers (the Rong-family cotton-textile firms, `CN-1930-1`; the wartime relocation of industry and universities, `CN-1940-1`; the Chengdu–Chongqing Railway, `CN-1952-1`, held for a second independent source) and everything from 2003 onward (Tesla, Facebook, and the rest). The console above shows the current count; it moves as batches land.
