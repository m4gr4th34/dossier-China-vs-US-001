...
This dossier is a two-country **achievement ledger**: a per-row-verified record of American and Chinese innovation, infrastructure, and social achievements from 1926 to 2026, built under a published selection rule and a published promotion standard. It is deliberately neither a triumphalist nor a declinist account — every row wears an honest status label, and the momentum layer is computed only as an explicitly **OPEN-CAVEATED** constructed index — shown with its full sensitivity bands and named exclusions, never as a measured verdict. The honest state today: 285 candidate rows, 282 ESTABLISHED, the rest one open challenge (OPEN-UNVERIFIED) and two provenance-flagged REPORTED items. **Don't trust this paper — run it.**

## Avenues

| Avenue | Thesis | Status | Forecast | Sources |
|---|---|---|---|---|
| The achievement ledger | A 285-row, event-anchored, per-row-verified corpus of US and Chinese achievements 1926–2026; 282 rows ESTABLISHED under a published promotion standard. The full 1926–2025 chronological corpus is processed, plus author-proposed per-row passes (batch 11: physical-manufacturing and 2023–2025 achievements; batch 12: maritime and defense-industrial) adding rows on both sides — each through the same ritual. | ESTABLISHED | — | verification_ritual.md, selection_criteria.md |
...
| Verification in progress | Live status: 282 ESTABLISHED, 1 OPEN-UNVERIFIED, 2 REPORTED. Batches 1–10 processed the full 1926–2025 corpus; a straggler sweep then removed one un-anchorable row and converted two more into anchored, verified rows; a batch-11 tail-and-stack pass added twelve ESTABLISHED physical-manufacturing and 2023–2025 rows plus one REPORTED row (a late-2025 Chinese domestic-EUV-lithography claim, interested-party sourced and uncorroborated — confirmed Chinese progress is DUV, not EUV); a batch-12 maritime/defense pass added two ESTABLISHED China rows (commercial-shipbuilding dominance; PLA Navy largest by hull count, carrying the mandatory caveat that the US Navy remains far larger by tonnage). Announced/under-construction items (Linglong-One SMR, second-gen batteries, Kimi K3, Columbia-class SSBN, AUKUS transfers) were held, not filed. Just ONE row stays open: the Chengdu–Chongqing Railway (CN-1952-1) — its July 1952 opening is uncontested, but no independent non-PRC source has been found, so it is posted as an open challenge (named credit for whoever closes it). The 2026 window is also not yet closed. | OPEN-UNVERIFIED | — | claim_ledger.csv, verification_log.md |
...
- [PASS] Census: 282 ESTABLISHED / 1 OPEN-UNVERIFIED / 2 REPORTED (live corpus counts)
...
The ledger itself — 285 rows, event-anchored, per-row-verified, 282 ESTABLISHED under the promotion standard — is the dossier's spine and its most finished part. It is asserted directly, because documented, dated, sourced achievements are bedrock, and timidity about them would be its own dishonesty.
